...
export function StatusBar() {
  ...
  return (
    <div className="hidden lg:flex h-7 bg-bg-activity border-t border-border-subtle items-center px-3 text-[11px] text-text-tertiary select-none" style={{ gridRow: '2', gridColumn: '1 / -1' }}>
      {/* Left: User + Role */}
